...
(function ($) {
  ...
  function createSkinBlock(colors, callback, noneSelected) {
    var $block = $('<selectcss />', {
      class: noneSelected ? 'custom-selectcss mb-3 border-0' : 'custom-selectcss mb-3 text-light border-0 ' + colors[0].replace(/accent-|navbar-/, 'bg-')
    })
  ...
  $navbar_variants_colors.removeClass().addClass('custom-selectcss mb-3 text-light border-0 ').addClass(active_navbar_color)
  ...
  // $accent_variants.removeClass().addClass('custom-selectcss mb-3 text-light border-0 ').addClass(active_accent_color)
  ...
  $sidebar_dark_variants.removeClass().addClass('custom-selectcss mb-3 text-light border-0 ').addClass(active_sidebar_dark_color)
  ...
  if (active_sidebar_light_color !== null) {
    ...
    $sidebar_light_variants.removeClass().addClass('custom-selectcss mb-3 text-light border-0 ').addClass(active_sidebar_light_color)
  }
  ...
  if (active_brand_color) {
    ...
    $brand_variants.removeClass().addClass('custom-selectcss mb-3 text-light border-0 ').addClass(active_brand_color)
  }
})(jQuery)
